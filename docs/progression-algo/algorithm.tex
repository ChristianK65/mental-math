...
\begin{itemize}[leftmargin=*]
    \item Level 1: 1-digit $\div$ 1-digit, 1-digit quotient
    \item Level 2: 2-digit $\div$ 1-digit, 1-digit quotient
    \item Level 3: 2-digit $\div$ 1-digit, 2-digit quotient
    \item Level 4: 2-digit $\div$ 2-digit, 1-digit quotient
    \item Level 5: 3-digit $\div$ 2-digit, 1-digit quotient
\end{itemize}
...
Only allow demotion after a minimum exposure at that level (10 attempts).
...
\textbf{DIV example (Level 4: 2-digit / 2-digit, exact integer)}
