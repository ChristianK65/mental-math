...
All division questions are \textbf{exact integer} divisions (no remainder). Difficulty is controlled by constraining the number of digits in the operands and the length (number of digits) of the quotient.

\begin{longtable}{@{}clccr@{}}
\toprule
\textbf{Level} & \textbf{Description} & \textbf{Dividend / Divisor} & \textbf{Quotient Digits} & \textbf{Cutoff (ms)} \\
\midrule
\endhead
1  & 1-digit $\div$ 1-digit & $1 \div 1$ & 1 & 4\,000 \\
2  & 2-digit $\div$ 1-digit & $2 \div 1$ & 1 & 4\,500 \\
3  & 2-digit $\div$ 1-digit & $2 \div 1$ & 2 & 5\,000 \\
4  & 2-digit $\div$ 2-digit & $2 \div 2$ & 1 & 5\,500 \\
5  & 3-digit $\div$ 2-digit & $3 \div 2$ & 1 & 6\,000 \\
6  & 3-digit $\div$ 1-digit & $3 \div 1$ & 2 & 6\,500 \\
7  & 3-digit $\div$ 2-digit & $3 \div 2$ & 2 & 6\,500 \\
8  & 3-digit $\div$ 1-digit & $3 \div 1$ & 3 & 7\,000 \\
9  & 4-digit $\div$ 2-digit & $4 \div 2$ & 2 & 7\,500 \\
10 & 4-digit $\div$ 3-digit & $4 \div 3$ & 2 & 8\,000 \\
\bottomrule
\end{longtable}

\paragraph{Notes.}
Questions are generated by first choosing a valid divisor and a quotient with the targeted number of digits, then computing the dividend
as their product.  This guarantees an integer result and controls the exact structural shape of the mental operation.  Levels 6–10 scale up to four-digit dividends
